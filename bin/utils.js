...
function draw(score, value) {
    if (score >= 0.9 && score <= 1) {
        return chalk_1.default.green("".concat(value, " (Good)"));
    }
    if (score >= 0.5 && score < 0.9) {
        return chalk_1.default.yellow("".concat(value, " (Needs Improvement)"));
    }
    return chalk_1.default.red("".concat(value, " (Poor)"));
}
exports.draw = draw;
